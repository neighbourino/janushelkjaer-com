...
<div class="overflow-hidden rounded-lg bg-gray-200 shadow py-24">
    <div
        class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0 divide-y divide-gray-200 ">
        <div
