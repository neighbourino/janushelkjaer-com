                ...
                <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                    <div class="relative aspect-2/1 h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                        <img class="absolute inset-0 size-full rounded-2xl bg-gray-800 object-cover shadow-2xl"
                            src="{{ asset('images/jh/jh-profile-003.jpg') }}" alt="Janus Helkjær">
                    </div>
                </div>
                <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                    <figure class="relative isolate pt-6 sm:pt-12">
                        ...
                        <figcaption class="mt-8 text-base">
                            <div class="font-semibold text-white">Janus Helkjær</div>
                            <div class="mt-1 text-gray-400">Digital Entrepreneur</div>
                        </figcaption>
                    </figure>
                </div>
            </div>
